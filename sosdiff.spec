...
Version: 0.0.0
Release: py3
Summary: Compare two sosreport by parsing `sos_reports/sos.json` to show the collected files differences and optionally the diff for those files.
...
%description
Compare two sosreport by parsing `sos_reports/sos.json` to show the collected files differences and optionally the diff for those files.
